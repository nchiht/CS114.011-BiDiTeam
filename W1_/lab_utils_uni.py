...
plt.style.use('/content/drive/MyDrive/CS114MachineLearning/W1_/deeplearning.mplstyle')
n_bin = 5
...
def plt_house_x(X, y,f_wb=None, ax=None):
    ...
    ax.set_ylabel('quantitative measure of disease progression \none year after baseline')
    ax.set_xlabel(f'BMI')
...
def plt_intuition(x_train, y_train):
    ...
    w_range = np.array([200-200,2000+2000])
    tmp_b = 100
...
def plt_stationary(x_train, y_train):
    ...
    w_range = np.array([2000-3000.,2000+3000])
    b_range = np.array([50-300., 50+300])
